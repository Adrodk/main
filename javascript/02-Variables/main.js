...
You will create seven variables as described below.
...
Create different variables to hold each of the following values:

01. A nice message to your users:
	value: "Welcome to JavaScript!"

02. The day WW2 ended:
	value: "1945-09-02"
...
var doYouLikeJavascript = true
console.log(doYouLikeJavascript)
...
var places = ['florida', 'georgia', 'south carolina', 'north carolina']
console.log(places);
...
var fictionalCharacters = {firstName: 'Star', lastName: 'Lord', movie: 'Space Avengers'}
console.log(fictionalCharacters);
