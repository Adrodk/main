...
var flName = "Albert Rodriguez";
var date = new Date().getFullYear();

document.getElementById('userName').innerHTML = `Hello ${flName}`;
document.getElementById('currentYear').innerHTML = `${date}`;



function updateWarnings(){
    document.querySelector('.alert-danger').innerHTML = "Your changes will be lost!";
    document.querySelector('.alert-warning').innerHTML = "If you are cool with losing your changes, so am I.";
    document.querySelector('.alert-success').innerHTML = "Just kidding, your changes are saved :P";
}

updateWarnings();

function updateWeather(){
    document.getElementById('currentWeather').innerHTML = 'Rainy';
}
updateWeather();